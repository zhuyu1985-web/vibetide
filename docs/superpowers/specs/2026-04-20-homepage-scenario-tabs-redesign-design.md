...
| 8 | `pub.feature_story_pipeline`（改名） | 精品内容（深度大稿） | xiaowen / 内容创作 | xiaolei, xiaoce, xiaozi, xiaowen, xiaoshen, xiaofa | `app_home` | deep |
...
// 修改点（其他字段保持不变）
{
  ...
  defaultTeam: ["xiaolei","xiaoce","xiaozi","xiaowen","xiaoshen","xiaofa"], // 🔧 固定 6 人
