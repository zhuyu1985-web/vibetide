...
description: 将一篇已有文章改写为指定风格，支持 9 种目标风格：新华体（严肃权威 / 标准官方语）、新闻标准体（客观白描）、深度体（长句 / 多维度 / 分析链）、网感体（短句 / 梗 / 互动）、种草体（亲切 / 个人经历 / 推荐感）、探店体（第一视角 / 体验细节）、娱乐体（轻松 / 玩梗 / 话题感）、简报体（要点式 / 极简）、评论体（观点鲜明 / 立场清晰）。典型用法：一次创作多平台分发（原稿 → 9 种适配版本）、外部通稿适配本台调性、多风格 A/B 测试、爆款改头换面二次创作。严格保留核心事实、数据、引用原话不动，只改变表达方式、句式、用词、人称视角。支持指定目标字数（原文 ±20%）、保留结构 / 重组结构、保留 / 打散原标题。当用户提及"改写""另一种风格""适配抖音""网感版""正式版""简报版""变通稿"等关键词时调用；不用于内容新生成或摘要。
version: 5.0.0
