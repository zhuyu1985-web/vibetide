  ...
  const templatesData = [
    {
      ...
      steps: [
        { id: "step-1", order: 1, dependsOn: [] as string[], name: "热点监控", type: "employee" as const, config: { employeeSlug: "xiaolei", parameters: {} }, key: "monitor", label: "热点监控", employeeSlug: "xiaolei" },
        { id: "step-2", order: 2, dependsOn: ["step-1"], name: "选题策划", type: "employee" as const, config: { employeeSlug: "xiaoce", parameters: {} }, key: "plan", label: "选题策划", employeeSlug: "xiaoce" },
        { id: "step-3", order: 3, dependsOn: ["step-2"], name: "内容创作", type: "employee" as const, config: { employeeSlug: "xiaowen", parameters: {} }, key: "create", label: "内容创作", employeeSlug: "xiaowen" },
        { id: "step-4", order: 4, dependsOn: ["step-3"], name: "质量审核", type: "employee" as const, config: { employeeSlug: "xiaoshen", parameters: {} }, key: "review", label: "质量审核", employeeSlug: "xiaoshen" },
        { id: "step-5", order: 5, dependsOn: ["step-4"], name: "渠道发布", type: "employee" as const, config: { employeeSlug: "xiaofa", parameters: {} }, key: "publish", label: "渠道发布", employeeSlug: "xiaofa" },
      ],
    },
    {
      name: "深度报道工作流",
      ...
      steps: [
        { id: "step-1", order: 1, dependsOn: [] as string[], name: "热点监控", type: "employee" as const, config: { employeeSlug: "xiaolei", parameters: {} }, key: "monitor", label: "热点监控", employeeSlug: "xiaolei" },
        { id: "step-2", order: 2, dependsOn: ["step-1"], name: "选题策划", type: "employee" as const, config: { employeeSlug: "xiaoce", parameters: {} }, key: "plan", label: "选题策划", employeeSlug: "xiaoce" },
        { id: "step-3", order: 3, dependsOn: ["step-2"], name: "素材准备", type: "employee" as const, config: { employeeSlug: "xiaozi", parameters: {} }, key: "material", label: "素材准备", employeeSlug: "xiaozi" },
        { id: "step-4", order: 4, dependsOn: ["step-3"], name: "内容创作", type: "employee" as const, config: { employeeSlug: "xiaowen", parameters: {} }, key: "create", label: "内容创作", employeeSlug: "xiaowen" },
        { id: "step-5", order: 5, dependsOn: ["step-4"], name: "视频制作", type: "employee" as const, config: { employeeSlug: "xiaojian", parameters: {} }, key: "produce", label: "视频制作", employeeSlug: "xiaojian" },
        { id: "step-6", order: 6, dependsOn: ["step-5"], name: "质量审核", type: "employee" as const, config: { employeeSlug: "xiaoshen", parameters: {} }, key: "review", label: "质量审核", employeeSlug: "xiaoshen" },
        { id: "step-7", order: 7, dependsOn: ["step-6"], name: "渠道发布", type: "employee" as const, config: { employeeSlug: "xiaofa", parameters: {} }, key: "publish", label: "渠道发布", employeeSlug: "xiaofa" },
        { id: "step-8", order: 8, dependsOn: ["step-7"], name: "数据分析", type: "employee" as const, config: { employeeSlug: "xiaoshu", parameters: {} }, key: "analyze", label: "数据分析", employeeSlug: "xiaoshu" },
      ],
    },
  ];
