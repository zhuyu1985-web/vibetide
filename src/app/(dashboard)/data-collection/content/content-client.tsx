          ...
          {items.map((item) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => setDetailItemId(item.id)}
                className="w-full flex items-center gap-3 px-5 py-3.5 border-b border-gray-200 dark:border-gray-700/60 last:border-b-0 hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-colors duration-200 text-left"
              >
