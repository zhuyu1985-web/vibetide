...
const dict: MediaOutletRow[] = [
  { id: "11111111-1111-1111-1111-111111111111", organizationId: "org-a", outletName: "人民日报", outletTier: "central", outletRegion: "全国", outletDistrict: null, industryTag: null, domains: ["people.com.cn", "paper.people.com.cn"], publicAccountNames: ["人民日报"], groupName: null, channels: [], description: null, isActive: true, createdAt: new Date(), updatedAt: new Date() } as MediaOutletRow,
  { id: "22222222-2222-2222-2222-222222222222", organizationId: "org-a", outletName: "中国环境报", outletTier: "industry", outletRegion: null, outletDistrict: null, industryTag: "环境", domains: ["cenews.com.cn"], publicAccountNames: ["中国环境"], groupName: null, channels: [], description: null, isActive: true, createdAt: new Date(), updatedAt: new Date() } as MediaOutletRow,
  { id: "33333333-3333-3333-3333-333333333333", organizationId: "org-a", outletName: "重庆日报", outletTier: "provincial_municipal", outletRegion: "重庆", outletDistrict: null, industryTag: null, domains: ["cqrb.cn"], publicAccountNames: ["重庆日报"], groupName: null, channels: [], description: null, isActive: true, createdAt: new Date(), updatedAt: new Date() } as MediaOutletRow,
  { id: "44444444-4444-4444-4444-444444444444", organizationId: "org-a", outletName: "涪陵发布", outletTier: "district_media", outletRegion: "重庆", outletDistrict: "涪陵区", industryTag: null, domains: [], publicAccountNames: ["涪陵发布"], groupName: null, channels: [], description: null, isActive: true, createdAt: new Date(), updatedAt: new Date() } as MediaOutletRow,
];
