/**
 * Subtemplates for zhongcao_script.
 *
 * TODO(follow-up issue): populate subtemplate detailed specs extracted from
 *   skills/zhongcao_script/SKILL.md §4.4 of Track B spec.
 * See: docs/superpowers/specs/2026-04-19-skill-md-baoyu-standardization.md §4.4
 *
 * Real content will be filled in after Track B PR merges. Keeping this stub
 * avoids blocking Track B's AC scriptPath existence check.
 */
