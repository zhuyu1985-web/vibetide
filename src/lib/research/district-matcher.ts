...
// V2 内置变体字典 — 重庆市 39 个区县(含 38 区县 + 万盛经开区 + 高新区 - 江北 - 渝北 + 两江新区)
// 江北区/渝北区合并到两江新区统计:正文提到"江北区""渝北区"时命中"两江新区"
export const DISTRICT_VARIANTS: Record<string, string[]> = {
  "涪陵区": ["涪陵区", "涪陵县", "涪陵"],
  "渝中区": ["渝中区", "渝中"],
  // 江北区/渝北区 合并到两江新区(按统计口径)
  "两江新区": ["两江新区", "江北区", "渝北区"],
  "九龙坡区": ["九龙坡区", "九龙坡"],
  "云阳县": ["云阳县", "云阳"],
  "巴南区": ["巴南区", "巴南"],
  ...
  "合川区": ["合川区", "合川市", "合川"],
  "潼南区": ["潼南区", "潼南县", "潼南"],
  // 注意:不能加 "高新区" 作为 alias — 全国各省市都有"国家高新区"/"中关村高新区"/"xx 高新区",
  // 加进去会把人民日报/新华社等中央媒体报道中所有"高新区"主题文章误算到重庆高新区(实测假阳性 806 条)
  "科学城重庆高新区": ["科学城重庆高新区", "西部科学城重庆高新区", "重庆高新区"],
  "城口县": ["城口县", "城口"],
